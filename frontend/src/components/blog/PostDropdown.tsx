...
export default function PostDropdown({ isDropdownOpen, postId, setDropOpen}) {
  ...
  return (
    <>
      <motion.div variants={variants} initial="hidden" animate={isDropdownOpen ? "visible" : "hidden"} className={`text-xs absolute right-1 top-8 w-24 shadow-sm bg-[#403d39] border-[1.5px] border-black/20 rounded-md flex flex-col  overflow-hidden z-[60]`}>
