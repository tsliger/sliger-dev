          ...
          <div className="absolute top-[20%]">
            <Parallax offset={150}>
              ...
              >
                ...
                passionate about developing elegant solutions to challenging
                problems. With a solid background in computer science and a keen
                eye for detail, I bring a depth of knowledge to each project I
                undertake. Whether it's building a scalable web application or
                designing a machine learning algorithm, I am dedicated to
                creating software that not only meets but exceeds client
                expectations.
              </motion.p>
            </Parallax>
          </div>
